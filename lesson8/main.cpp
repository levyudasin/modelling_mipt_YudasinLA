...
inline double v_t(double t, double x, double v){
    return -omega_sqr*x - beta * v;
}
...
int main(int argc, char** argv){
    ...
    std::cout << int(simTime / dt) << std::endl;
    ...
    std::cout << (float)elapsed_ns.count() / 1000000000 << " s" << std::endl;
    return 0;
}